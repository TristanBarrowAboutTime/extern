...
const ScheduledGrid = (props: NormalGridProps) => {
    ...
    const headerRow = [
        ...
        <HeaderCell>Frequency Type</HeaderCell>,
        <HeaderCell>Next Run Date/Time</HeaderCell>,
        <HeaderCell>Last Run Date/Time</HeaderCell>
    ]
    ...
    const setupGrid = (data: any) => {
        ...
        data.forEach((element: Row, index: number) => {
            if (element.reportName.toLowerCase().includes(props.searchValue.toLowerCase()) ||
                ...
                element.frequencyType.toLowerCase().includes(props.searchValue.toLowerCase()) || 
                element.nextRunDate.toLowerCase().includes(props.searchValue.toLowerCase()) || 
